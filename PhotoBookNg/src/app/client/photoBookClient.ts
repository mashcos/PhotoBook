...
/**
 * Instantiates a new {@link PhotoBookClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createPhotoBookClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PhotoBookClient>(requestAdapter, pathParameters, PhotoBookClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface PhotoBookClient extends BaseRequestBuilder<PhotoBookClient> {
    /**
     * The api property
     */
 ...
 */
export const PhotoBookClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const PhotoBookClientNavigationMetadata: Record<Exclude<keyof PhotoBookClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
